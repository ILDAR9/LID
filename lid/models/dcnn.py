...
def dcnn(bands=60, frames=31, n_classes=3, fully_connected=5000, filters=80, activation='relu'):
    """
    ...
    m = Dense(fully_connected // 2, activation=activation)(m)
...
def dcnn_nodelta(bands=60, frames=31, n_classes=3, channels=1,
                 fully_connected=5000, filters=80, activation='relu', **kwargs):
    from keras.models import Model
    from keras.layers import Dense, Input
