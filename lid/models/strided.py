...
from keras.layers import SeparableConv2D, Conv2D, DepthwiseConv2D, ZeroPadding2D
...
def conv_effnet(x, kernel, filters, downsample, name, bottleneck=0.5, strides=(1, 1), padding='same', bias=False):
    """Pointwise -> Spatially Separable conv&pooling Effnet style"""
...
def build_model(frames=128, bands=128, channels=1, n_classes=3,
                conv_size=(5, 5),
                conv_block='conv',
                downsample_size=(2, 2),
